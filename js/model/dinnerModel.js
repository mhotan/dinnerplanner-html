    ...
    this.getAllDishes = function (type,filter) {
        return $(dishes).filter(function(index,dish) {
            ...
            if(filter){
                ...
                // For each of the ingredients in each of the dishes.
                // Check if we a match with an ingredient name.
                ...
                // Check if the name of the dish is a match with the filter.
                if(dish.name.toLowerCase().indexOf(filter.toLowerCase()) != -1) {
                    found = true;
                }
            }
            // If there is no filter then just show all the dishes.
            if (type == 'all') {
                return found;
            }
            // If there is a filter then ensure the type of the dish and the filter are the same
